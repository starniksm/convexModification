...
class TestPolygon1:
    ...
    def test_min_d3(self):
        assert self.f.min_d() == approx(5.0)

    def test_min_d4(self):
        assert self.f.add(R2Point(5.0, 5.0)).min_d() == approx(5.0)

    def test_min_d5(self):
        assert self.f.add(R2Point(0.0, 5.0)).min_d() == approx(sqrt(34))

    def test_min_d6(self):
        assert self.f.add(R2Point(-1.0, 1.0)).min_d() == approx(sqrt(17))
